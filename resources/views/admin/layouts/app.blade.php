...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('assets/admin/css/tabler-vendors.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/admin/css/tabler-marketing.css') }}" rel="stylesheet" />
    <link href="{{ asset('assets/admin/css/tabler-themes.css') }}" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
  ...
  <body>
    ...
    <script src="{{ asset('assets/admin/libs/jsvectormap/dist/jsvectormap.min.js') }}" defer></script>
