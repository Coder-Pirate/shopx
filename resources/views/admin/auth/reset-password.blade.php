    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="{{ route('admin.password.store') }}" method="post" autocomplete="off" novalidate>
          ...
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Reset password by minhaz</h2>
            <p class="text-secondary mb-4">Enter your email and new password to reset your password.</p>
            ...
            <div class="mb-3">
              ...
              <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" />
              @error('email')
            ...
            <div class="mb-3">
              ...
              <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Confirm new password" required autocomplete="new-password" />
